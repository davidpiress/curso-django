...
SECRET_KEY = 'django-insecure-o2y74wpe1qne*iho^l6i^(6e@fcq+&0%5ffgz*#(3uixqak!jl'
...
DATABASES = {
   'default': config('DATABASES_URL', default=default_db_url, cast=parse_database)
}
...
if SENTRY_DNS:
    sentry_sdk.init(
        dsn="https://4ad2017840484dfe868c077b6b98ecc8@o4505428233289728.ingest.sentry.io/4505428263632896",
        integrations=[
            DjangoIntegration(),
        ],
